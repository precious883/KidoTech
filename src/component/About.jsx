...
const About = () => (
  <section className="about-section">
    ...
    <ul>
      Our expanded suite of services includes:<br/>
            
      <li>🔍 Web Optimisation – enhancing performance, SEO, and user experience<br/></li>
      <li>📈 Digital Marketing – driving growth through data-driven campaigns<br/></li>
      <li>🎯 Brand Advert & Promotion – crafting creative strategies that resonate </li>
    ...
    <span>
      Mission: To build intelligent, user-centric software that solves real-world problems<br/>
      Vision: To be Africa’s leading hub for AI-powered digital transformation<br/>
